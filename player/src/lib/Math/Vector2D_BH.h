/**
 * @file Vector2D_BH.h
 * Contains template class Vector2D_BH of type V
 *
...
#ifndef __Vector2D_BH_h__
#define __Vector2D_BH_h__

#include <math.h>

/** This class represents a 2-vector */
template <class V> class Vector2D_BH{
  public:
  ...
  /** Default constructor. */
  Vector2D_BH<V>():x(0),y(0)
  {
  }
  /** Default constructor. */
  Vector2D_BH<V>(V x, V y):x(x),y(y)
  {
  }
  ...
  */
  Vector2D_BH<V>& operator=(const Vector2D_BH<V>& other)
  {
    x=other.x;y=other.y;
    return *this;
  }
  ...
  */
  Vector2D_BH<V>(const Vector2D_BH<V>& other) {*this = other;}
  ...
  *\return A reference to this object after the calculation.
  */
  Vector2D_BH<V>& operator*=(const V& factor)
  {
    x *= factor;
    y *= factor;
    return *this;
  ...
  */
  Vector2D_BH<V> operator+(const Vector2D_BH<V>& other) const
    {return Vector2D_BH<V>(*this) += other;}
  ...
  *\return A new object that contains the result of the calculation.
  */
  Vector2D_BH<V> operator*(const V& factor) const
    {return Vector2D_BH<V>(*this) *= factor;}
  ...
  */
  bool operator==(const Vector2D_BH<V>& other) const
  {
    return (x==other.x && y==other.y);
  }
  ...
  *\return the rotated vector.
  */
  Vector2D_BH<V> rotate(double alpha)
  { double buffer = x;
    double a = cos(alpha);
    double b = sin(alpha);
