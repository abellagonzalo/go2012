...
public:
  ...
  */
  virtual double probabilityAt(const Vector2D_BH<double>& pos) const;
  ...
  */
  void getEigenVectorsAndEigenValues(Vector2D_BH<double>& eVec1, Vector2D_BH<double>& eVec2,
