...
bool Recorder::Initial2Record0_transition_code(void)
{
...
Recorder::step(void)
{
	...
	case Record:
		...
		break;
	default:
		cout << "[Recorder::step()] Invalid state\n";
	}
}
...
void
Recorder::init(const string newName, AL::ALPtr<AL::ALBroker> parentBroker)
{
