...
else
{
	...
	case TXTFCAA:
		poseInit(1.0);
		fisioCabezaArribaAbajo();
		kicktime = 2000;
		break;
	case TXTFCID:
		poseInit(1.0);
		fisioCabezaIzquierdaDerecha();
		kicktime = 2000;
		break;
	case TXTFBPAA:
		poseInit(1.0);
		fisioBrazosParalelosArribaAbajo();
		kicktime = 2000;
		break;
	case TXTFBAAA:
		poseInit(1.0);
		fisioBrazosAlternosArribaAbajo();
		kicktime = 2000;
		break;
	case TXTFBCAC:
		poseInit(1.0);
		fisioBrazosCruzAbrirCerrar();
		kicktime = 2000;
		break;
	case TXTFBTH:
		poseInit(1.0);
		fisioBrazosTocarHombro();
		kicktime = 2000;
		break;
	case TXTFMPV:
		poseInit(1.0);
		fisioMunecaPalmaVuelta();
		kicktime = 2000;
		break;
	case FIXED:
		poseInit(0.2);
...
Body::selKick(string kicksel)
{
	if (kicksel == "TXTFWDRR")
		selKick(TXTFWDRR);
	else if (kicksel == "TXTFWDRL")
		selKick(TXTFWDRL);
	else if (kicksel == "TXTFWNR")
		selKick(TXTFWNR);
	else if (kicksel == "TXTFWNL")
		selKick(TXTFWNL);
	else if (kicksel == "TXTFWSTR")
		selKick(TXTFWSTR);
	else if (kicksel == "TXTFWSTL")
		selKick(TXTFWSTL);
	else if (kicksel == "TXTSIDE2RI")
		selKick(TXTSIDE2RI);
	else if (kicksel == "TXTSIDE2LI")
		selKick(TXTSIDE2LI);
	else if (kicksel == "TXTSIDE2RSI")
		selKick(TXTSIDE2RSI);
	else if (kicksel == "TXTSIDE2LSI")
		selKick(TXTSIDE2LSI);
	else if (kicksel == "TXTSIDE2RO")
		selKick(TXTSIDE2RO);
	else if (kicksel == "TXTSIDE2LO")
		selKick(TXTSIDE2LO);
	else if (kicksel == "TXTOB2R")
		selKick(TXTOB2R);
	else if (kicksel == "TXTOB2L")
		selKick(TXTOB2L);
	else if (kicksel == "TXTSTANDB")
		selKick(TXTSTANDB);
	else if (kicksel == "TXTSTANDF")
		selKick(TXTSTANDF);
	else if (kicksel == "TXTSUICIDE")
		selKick(TXTSUICIDE);
	else if (kicksel == "TXTBWR")
		selKick(TXTBWR);
	else if (kicksel == "TXTBWL")
		selKick(TXTBWL);
	else if (kicksel == "TXTFCAA")
		selKick(TXTFCAA);
	else if (kicksel == "TXTFCID")
		selKick(TXTFCID);
	else if (kicksel == "TXTFBPAA")
		selKick(TXTFBPAA);
	else if (kicksel == "TXTFBAAA")
		selKick(TXTFBAAA);
	else if (kicksel == "TXTFBCAC")
		selKick(TXTFBCAC);
	else if (kicksel == "TXTFBTH")
		selKick(TXTFBTH);
	else if (kicksel == "TXTFMPV")
		selKick(TXTFMPV);
	else
	{
		kick = FIXED;
...
Body::doMove(const string& kick, const Ice::Current& c)
{
	if (kick == "TXTFWDRR")
		selKick(TXTFWDRR);
	else if (kick == "TXTFWDRL")
		selKick(TXTFWDRL);
	else if (kick == "TXTFWNR")
		selKick(TXTFWNR);
	else if (kick == "TXTFWNL")
		selKick(TXTFWNL);
	else if (kick == "TXTFWSTR")
		selKick(TXTFWSTR);
	else if (kick == "TXTFWSTL")
		selKick(TXTFWSTL);
	else if (kick == "TXTSIDE2RI")
		selKick(TXTSIDE2RI);
	else if (kick == "TXTSIDE2LI")
		selKick(TXTSIDE2LI);
	else if (kick == "TXTSIDE2RSI")
		selKick(TXTSIDE2RSI);
	else if (kick == "TXTSIDE2LSI")
		selKick(TXTSIDE2LSI);
	else if (kick == "TXTSIDE2RO")
		selKick(TXTSIDE2RO);
	else if (kick == "TXTSIDE2LO")
		selKick(TXTSIDE2LO);
	else if (kick == "TXTOB2R")
		selKick(TXTOB2R);
	else if (kick == "TXTOB2L")
		selKick(TXTOB2L);
	else if (kick == "TXTSTANDB")
		selKick(TXTSTANDB);
	else if (kick == "TXTSTANDF")
		selKick(TXTSTANDF);
	else if (kick == "TXTSUICIDE")
		selKick(TXTSUICIDE);
	else if (kick == "TXTBWR")
		selKick(TXTBWR);
	else if (kick == "TXTBWL")
		selKick(TXTBWL);
	else if (kick == "TXTFCAA")
		selKick(TXTFCAA);
	else if (kick == "TXTFCID")
		selKick(TXTFCID);
	else if (kick == "TXTFBPAA")
		selKick(TXTFBPAA);
	else if (kick == "TXTFBAAA")
		selKick(TXTFBAAA);
	else if (kick == "TXTFBCAC")
		selKick(TXTFBCAC);
	else if (kick == "TXTFBTH")
		selKick(TXTFBTH);
	else if (kick == "TXTFMPV")
		selKick(TXTFMPV);
	else
		selKick(kick);
}
...
Body::doKickL2(int foot)
{
	...
	f = pmotion->post.positionInterpolation(arms, 2, path2, 63, 1.0*time, false);
	movet.push_back(f);*/
...
/////////////////VOLVEMOS A POSICION INICIAL///////////////////////////
	...
	f = pmotion->post.positionInterpolation("Torso", 2, path3, 63, 5.0*time, false);
	movet.push_back(f);
	...
	f = pmotion->post.positionInterpolation(foots, 2, path4, 63, 5.0*time, false);
	//movet.push_back(f);
	movet.push_back(f); //para que haga los 2 movs
*/
}
