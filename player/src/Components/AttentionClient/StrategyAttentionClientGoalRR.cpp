...
StrategyAttentionClientGoalRR::StrategyAttentionClientGoalRR()
{
...
void
StrategyAttentionClientGoalRR::getAP(tapoint **ap){
...
void
StrategyAttentionClientGoalRR::atAP(){
...
void
StrategyAttentionClientGoalRR::initListAP(){
...
void
StrategyAttentionClientGoalRR::APnotValid(){
	forcesearch = true;

}
void
StrategyAttentionClientGoalRR::updateAP()
{
