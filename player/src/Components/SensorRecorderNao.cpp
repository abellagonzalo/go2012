...
SensorRecorderNao::step(void)
{
	...
	/*Save image*/
  ss << this->it;
	this->file_name_image = this->file_root + "imagen" + ss.str() + ".jpg";
	...
	/*Save data*/
  file_data << "IT " << this->it << endl;
  file_data << "TIME " << diff_time/1000 << endl;
	file_data << "POSE " << robotx << " " << roboty << " " << robott << endl;
	file_data << "ODOM " << datak->x << " " << datak->y << " " << datak->z << " " << datak->pan << " " << datak->tilt << " " << datak->roll << endl;	
