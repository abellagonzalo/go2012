#ifndef NEKFLOCALIZATION_H
#define NEKFLOCALIZATION_H
...
class NEKFLocalization : public AbstractLocalization, public Singleton<NEKFLocalization>, public DebugIRel, public DebugIAbs, public NEKFLineDbgManager
{
public:
