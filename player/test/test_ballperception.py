...
"""
print '        START TESTING BallPerception MODULE'
...
# Put here IP and Port of a broker containg BallPerception        
IP="127.0.0.1"
PORT=9559
...
try:
  BallPerception_Proxy = ALProxy("BallPerception",IP,PORT)
except Exception,e:
  print "Error when creating BallPerception  proxy:"
  print str(e)
  exit(1)
#________________________________
...
try:
  ret = BallPerception_Proxy.DummyFunction( "hello, world", inParam )
except Exception,e:
  print "BallPerception test Failed"
  exit(1)
...
if (ret == inParam):
  ...
  print '            BallPerception MODULE TESTED'
  print ''
  exit(0)
else:
