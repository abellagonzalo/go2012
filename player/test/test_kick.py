...
"""
print '        START TESTING Kick MODULE'
...
# Put here IP and Port of a broker containg Kick        
IP="127.0.0.1"
PORT=9559
...
try:
  Kick_Proxy = ALProxy("Kick",IP,PORT)
except Exception,e:
  print "Error when creating Kick  proxy:"
  print str(e)
  exit(1)
#________________________________
...
try:
  ret = Kick_Proxy.DummyFunction( "hello, world", inParam )
except Exception,e:
  print "Kick test Failed"
  exit(1)
