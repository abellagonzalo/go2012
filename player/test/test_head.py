...
"""
print '        START TESTING Head MODULE'
...
# Put here IP and Port of a broker containg Head        
IP="127.0.0.1"
PORT=9559
...
try:
  Head_Proxy = ALProxy("Head",IP,PORT)
except Exception,e:
  print "Error when creating Head  proxy:"
  print str(e)
  exit(1)
#________________________________
...
try:
  ret = Head_Proxy.DummyFunction( "hello, world", inParam )
except Exception,e:
  print "Head test Failed"
  exit(1)
