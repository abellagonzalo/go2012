...
"""
print '        START TESTING Turn MODULE'
...
# Put here IP and Port of a broker containg Turn        
IP="127.0.0.1"
PORT=9559
...
try:
  Turn_Proxy = ALProxy("Turn",IP,PORT)
except Exception,e:
  print "Error when creating Turn  proxy:"
  print str(e)
  exit(1)
#________________________________
...
try:
  ret = Turn_Proxy.DummyFunction( "hello, world", inParam )
except Exception,e:
