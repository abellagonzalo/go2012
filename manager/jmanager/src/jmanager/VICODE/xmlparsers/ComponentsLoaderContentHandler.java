 ...
 */
public class ComponentsLoaderContentHandler implements ContentHandler {
	...
	public ComponentsLoaderContentHandler() {
	}
	...
	public void startElement(String namespaceURI, String localName,
		...
		if (localName.equals("dependenceComponent")) {
			...
			Component comp = gui.addComponent(id);
			comp.setXYpos(x, y);
			comp.centerIdText();
		}
	}
