 ...
 * @author paco
 */
public class GTLocalization extends javax.swing.JPanel {

	/** Creates new form GTLocalization */
	public GTLocalization() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(jmanager.JmanagerApp.class).getContext().getResourceMap(GTLocalization.class);
	...
	private void ActivationCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActivationCheckBoxActionPerformed
		if (ActivationCheckBox.isSelected()) {
			JmanagerView.root.getConnection().schedulerPrx.run("GTLocalization");
			//dataResp resp = JmanagerView.root.getConnection().send("run:GTLocalization:");

		} else {
			JmanagerView.root.getConnection().schedulerPrx.stop("GTLocalization");
			//dataResp resp = JmanagerView.root.getConnection().send("pause:GTLocalization:");
			//printResp(resp);
		}
