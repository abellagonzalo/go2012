 ...
 * @author paco
 */
public class PruebaAttention extends javax.swing.JPanel {

	/** Creates new form ComponentGTLocalization */
	public PruebaAttention() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(PruebaAttention.class);
	...
	private void ActivationCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActivationCheckBoxActionPerformed
		if (ActivationCheckBox.isSelected()) {
			JmanagerView.root.getConnection().schedulerPrx.run("PruebaAttention");
			//dataResp resp = JmanagerView.root.getConnection().send("run:PruebaAttention:");

		} else {
			JmanagerView.root.getConnection().schedulerPrx.stop("PruebaAttention");
			//dataResp resp = JmanagerView.root.getConnection().send("pause:PruebaAttention:");
			//printResp(resp);
		}
