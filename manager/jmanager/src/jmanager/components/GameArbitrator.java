 ...
 * @author paco
 */
public class GameArbitrator extends javax.swing.JPanel {

	/** Creates new form ComponentGTLocalization */
	public GameArbitrator() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(GameArbitrator.class);
	...
	private void ActivationCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActivationCheckBoxActionPerformed
		if (ActivationCheckBox.isSelected()) {
			JmanagerView.root.getConnection().schedulerPrx.run("GameArbitrator");
			//dataResp resp = JmanagerView.root.getConnection().send("run:GameArbitrator:");

		} else {
			JmanagerView.root.getConnection().schedulerPrx.stop("GameArbitrator");
			//dataResp resp = JmanagerView.root.getConnection().send("pause:GameArbitrator:");
			//printResp(resp);
		}
