 ...
 * @author paco
 */
public class Attention extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(Attention.class);
	...
	private void ActivationCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActivationCheckBoxActionPerformed
		if (ActivationCheckBox.isSelected()) {
			JmanagerView.root.getConnection().schedulerPrx.run("Attention");			
		} else {
			JmanagerView.root.getConnection().schedulerPrx.stop("Attention");			
		}
