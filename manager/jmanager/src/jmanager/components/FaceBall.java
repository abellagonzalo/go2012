 ...
 * @author paco
 */
public class FaceBall extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(jmanager.JmanagerApp.class).getContext().getResourceMap(FaceBall.class);
	...
	private void ActivationCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ActivationCheckBoxActionPerformed
		if (ActivationCheckBox.isSelected()) {
			JmanagerView.root.getConnection().schedulerPrx.run("FaceBall");
			//dataResp resp = JmanagerView.root.getConnection().send("run:FaceBall:");

		} else {
			JmanagerView.root.getConnection().schedulerPrx.stop("FaceBall");
			//dataResp resp = JmanagerView.root.getConnection().send("pause:FaceBall:");
			//printResp(resp);
		}
